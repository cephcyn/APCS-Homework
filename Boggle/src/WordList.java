...
public class WordList extends ArrayList<String> {
    ...
    private double[] letterRatio = new double[26];
            ...
            try {
                ...
                while (scanner.hasNext()) {
                    ...
                    if (word.length() >= min && word.length() <= max) {
                        ...
                        // compile letterCount into letterRatio
    ...
    public String nextLetter() {
        ...
        double randletter = rand.nextDouble();
        double readsum = 0;
        for (int i = 0; i < letterRatio.length; i++) {
            readsum += letterRatio[i];
            if (randletter < readsum) {
                return "" + (char) ('A' + i);
            }
        }
